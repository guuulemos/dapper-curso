...
namespace eCommerce.API.Repositories
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        {
            new Usuario() { Id = 1, Nome = "Gustavo", Email = "Gustavo@email.com" },
            new Usuario() { Id = 2, Nome = "Marcelo", Email = "Marcelo@email.com" },
            new Usuario() { Id = 3, Nome = "Raissa", Email = "Raissa@email.com" }
        };
